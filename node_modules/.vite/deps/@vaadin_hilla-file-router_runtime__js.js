    ...
    (function(root, factory) {
      ...
      atmosphere2 = {
        ...
        WebsocketApiAdapter: function(request) {
          ...
          request.onMessage = function(e3) {
            _adapter.onmessage({ data: e3.responseBody });
          };
          request.onMessagePublished = function(e3) {
            _adapter.onmessage({ data: e3.responseBody });
          };
          request.onOpen = function(e3) {
            _adapter.onopen(e3);
          };
          _adapter = {
            close: function() {
          ...
          _socket = new atmosphere2.subscribe(request);
          return _adapter;
        },
        AtmosphereRequest: function(options) {
          ...
          function _disconnect() {
            if (_request.enableProtocol && !_request.disableDisconnect && !_request.firstMessage) {
              ...
              atmosphere2.util.each(_request.headers, function(name, value) {
                var h3 = atmosphere2.util.isFunction(value) ? value.call(this, _request, _request, _response) : value;
                if (h3 != null) {
                  query += "&" + encodeURIComponent(name) + "=" + encodeURIComponent(h3);
                }
              });
                ...
                return {
                  init: function() {
                    ...
                    win.fire = function(string) {
                      var i2;
                      for (i2 = 0; i2 < win.callbacks.length; i2++) {
                        win.callbacks[i2](string);
                      }
                    };
                  },
                  signal: function(type, data) {
          ...
          function _handleProtocol(request, message) {
            ...
            if (request.enableProtocol && request.firstMessage && atmosphere2.util.trim(message).length !== 0) {
              ...
              if (messages.length > pos + 1) {
                for (var i2 = pos; i2 < messages.length; i2++) {
                  nMessage += messages[i2];
                  if (i2 + 1 !== messages.length) {
          ...
          function _attachHeaders(request, url) {
            ...
            atmosphere2.util.each(rq.headers, function(name, value) {
              var h3 = atmosphere2.util.isFunction(value) ? value.call(this, rq, request, _response) : value;
              if (h3 != null) {
                url += "&" + encodeURIComponent(name) + "=" + encodeURIComponent(h3);
              }
            });
            return url;
          }
          ...
          function _doRequest(ajaxRequest, request, create) {
            ...
            if (!_request.dropHeaders) {
              ...
              atmosphere2.util.each(request.headers, function(name, value) {
                var h3 = atmosphere2.util.isFunction(value) ? value.call(this, ajaxRequest, request, create, _response) : value;
                if (h3 != null) {
                  ajaxRequest.setRequestHeader(name, h3);
                }
              });
            }
          ...
          function _localMessage(message) {
            ...
            if (m2.id !== guid2) {
              if (typeof _request.onLocalMessage !== "undefined") {
                ...
                atmosphere2.util.onLocalMessage(m2.event);
              }
            }
          }
          ...
          function _invokeCallback() {
            ...
            for (var i2 = 0; i2 < messages.length; i2++) {
              if (messages.length > 1 && messages[i2].length === 0) {
                continue;
              }
              _response.responseBody = isString ? atmosphere2.util.trim(messages[i2]) : messages[i2];
              if (_localStorageService == null && _localSocketF != null) {
                _localSocketF(_response.responseBody);
              }
              ...
              if (callbacks.length > 0) {
                ...
                try {
                  ...
                  atmosphere2.util.log(_request.logLevel, ["Callback exception" + e3]);
                }
              }
      ...
      atmosphere2.unsubscribe = function() {
        if (requests.length > 0) {
          ...
          for (var i2 = 0; i2 < requestsClone.length; i2++) {
            var rq = requestsClone[i2];
            rq.close();
      ...
      atmosphere2.unsubscribeUrl = function(url) {
        var idx = -1;
        if (requests.length > 0) {
          for (var i2 = 0; i2 < requests.length; i2++) {
            var rq = requests[i2];
            if (rq.getUrl() === url) {
              rq.close();
              clearTimeout(rq.response.request.id);
      ...
      atmosphere2.util = {
        ...
        param: function(params) {
          ...
          function add(key, value) {
            ...
            s3.push(encodeURIComponent(key) + "=" + encodeURIComponent(value));
          }
          function buildParams(prefix2, obj) {
            var name;
            if (atmosphere2.util.isArray(obj)) {
              atmosphere2.util.each(obj, function(i2, v3) {
                if (/\[\]$/.test(prefix2)) {
                  add(prefix2, v3);
                } else {
                  buildParams(prefix2 + "[" + (typeof v3 === "object" ? i2 : "") + "]", v3);
                }
              });
        ...
        each: function(obj, callback, args) {
          if (!obj) return;
          var value, i2 = 0, length = obj.length, isArray = atmosphere2.util.isArray(obj);
          if (args) {
            if (isArray) {
              for (; i2 < length; i2++) {
      ...
      atmosphere2.callbacks = {
        ...
        online: function() {
          ...
          if (requests.length > 0) {
            for (var i2 = 0; i2 < requests.length; i2++) {
              if (requests[i2].request.handleOnlineOffline) {
                requests[i2].init();
                requests[i2].execute();
              }
            }
...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState = React.useState, useEffect2 = React.useEffect, useLayoutEffect = React.useLayoutEffect, useDebugValue = React.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var _a;
var CookieManager = api.withAttributes({ path: calculatePath(new URL(((_a = globalThis.document) == null ? void 0 : _a.baseURI) ?? "/")) });
...
var ActionOnLostSubscription = function(ActionOnLostSubscription2) {
  ActionOnLostSubscription2["RESUBSCRIBE"] = "resubscribe";
  ActionOnLostSubscription2["REMOVE"] = "remove";
  return ActionOnLostSubscription2;
}({});
var FluxSubscriptionState = function(FluxSubscriptionState2) {
...
var _a2;
(_a2 = $wnd.Vaadin).registrations ?? (_a2.registrations = []);
...
function protectRoute(route, redirectPath = "/login") {
  var _a4;
  const { handle } = route;
  const requiresAuth = (handle == null ? void 0 : handle.loginRequired) ?? (handle == null ? void 0 : handle.requiresLogin) ?? ((_a4 = handle == null ? void 0 : handle.rolesAllowed) == null ? void 0 : _a4.length);
  if (requiresAuth) {
  ...
  withFileRoutes(routes) {
    return this.update(routes, ({ original, overriding: added, children }) => {
      ...
      if (added) {
        ...
        const handle = {
          ...module == null ? void 0 : module.config,
          title: ((_a4 = module == null ? void 0 : module.config) == null ? void 0 : _a4.title) ?? convertComponentNameToTitle(module == null ? void 0 : module.default),
  ...
  withFallback(component, config) {
    ...
    this.update(fallbackRoutes, ({ original, overriding: added, children, dupe }) => {
      if (original && !getRouteHandleFlag(original, RouteHandleFlags.IGNORE_FALLBACK) && !dupe) {
        ...
        if (children.some(({ index: i2, path }) => i2 ?? (path == null ? void 0 : path.includes("?")))) {
          _fallback.pop();
        }
        return {
          ...original,
      ...
      if (original && added) {
        ...
        for (const pathKey of pathKeys) {
          ...
          if (originalRoutes.length > 0 && addedRoute) {
            for (let i2 = 0; i2 < originalRoutes.length; i2++) {
              final.push(callback({
                original: originalRoutes[i2],
                overriding: addedRoute,
                children: next([originalRoutes[i2].children, addedRoute.children]),
                dupe: i2 < originalRoutes.length - 1
              }) ?? originalRoutes[i2]);
            }
            ...
            for (let i2 = 0; i2 < originalRoutes.length; i2++) {
              final.push(callback({
                original: originalRoutes[i2],
                children: next([originalRoutes[i2].children, void 0]),
                dupe: i2 < originalRoutes.length - 1
              }) ?? originalRoutes[i2]);
            }
          } else {
...
withLayoutSkipping_fn = function() {
  __privateGet(this, _modifiers).push((originalRoutes) => {
    ...
    const result = transformTree(originalRoutes, null, (routes, next) => routes.reduce((lists, route) => {
      ...
      if (!((_a4 = route.children) == null ? void 0 : _a4.length)) {
...
function useViewConfig() {
  ...
  return (_a4 = matches[matches.length - 1]) == null ? void 0 : _a4.handle;
}
...
var s2 = import_react4.version.split(".").map(Number)[0];
...
var P = "undefined" != typeof window ? import_react4.useLayoutEffect : import_react4.useEffect;
function $(n2) {
  if (void 0 === n2) n2 = 0;
  x();
  var t2 = (0, import_react4.useRef)();
...
var ServerConnection = class {
  ...
  disconnect() {
    var _a4;
    (_a4 = __privateGet(this, _subscription)) == null ? void 0 : _a4.cancel();
...
var _a3;
var viewsSignal = d((_a3 = window.Vaadin) == null ? void 0 : _a3.views);
function isExcluded(value) {
  var _a4;
  return !!((_a4 = value.menu) == null ? void 0 : _a4.exclude);
}
...
function createMenuItems() {
  ...
  return views.filter(([path, value]) => !isExcluded(value) && !hasVariablePathSegment(path)).map(([path, config]) => {
    ...
    return {
      to: path,
      icon: (_a4 = config.menu) == null ? void 0 : _a4.icon,
...
if (import.meta.hot) {
  import.meta.hot.on("fs-route-update", () => {
    fetch("?v-r=routeinfo").then(async (resp) => resp.json()).then((json) => {
      ...
      console.error("Failed to fetch route info", e3);
    });
  });
}
export {
